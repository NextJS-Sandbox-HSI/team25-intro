  ...
  return (
    <div className="relative min-h-[100dvh] flex items-center justify-center">
      ...
      >
        ...
        >
          The Only "come back" i'll be going back to -for sure-, is to my Rabb
        </motion.p>
        ...
        >
          {[
            { href: "https://github.com/isnaenihidayat", icon: "simple-icons:github", label: "GitHub", color: "hover:text-gray-900 dark:hover:text-white" },
            { href: "https://linkedin.com/in/isnaeni-hidayat", icon: "skill-icons:linkedin", label: "LinkedIn", color: "hover:text-blue-600" },
            { href: "mailto:me@isnaenihidayat.id", icon: "material-icon-theme:email", label: "Email", color: "hover:text-green-600" },
            { href: "https://instagram.com/isnaeni.abusyafiq", icon: "simple-icons:instagram", label: "Instagram", color: "hover:text-pink-600" },
            { href: "https://isnaenihidayat.id", icon: "simple-icons:googlechrome", label: "Portfolio", color: "hover:text-purple-600" },
            { href: "https://facebook.com/isnaeni.abusyafiq", icon: "simple-icons:facebook", label: "Facebook", color: "hover:text-blue-800" }
          ].map((link) => (

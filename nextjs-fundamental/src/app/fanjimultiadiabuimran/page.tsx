...
// Komponen untuk bagian Pengalaman
...
export default function Fanjimultiadiabuimran() {
    // State untuk mengontrol halaman mana yang aktif
    ...
    return (
        <div className={`${styles.container} min-h-screen flex flex-col items-center justify-center p-4`}>
            ...
            <div className="w-full max-w-4xl mx-auto bg-black bg-opacity-25 backdrop-blur-md rounded-2xl shadow-2xl text-center overflow-hidden">
                ...
                {/* Bilah Navigasi */}
                <nav className="bg-black bg-opacity-20 p-4 flex justify-center space-x-4">
                    <button 

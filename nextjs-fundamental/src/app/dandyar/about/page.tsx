export default function Dandyar() {
  return (
    <div className="w-full max-w-4xl border border-white border-opacity-20 mx-auto bg-black bg-opacity-25 backdrop-blur-md rounded-2xl shadow-2xl p-8 md:p-12 text-center">
